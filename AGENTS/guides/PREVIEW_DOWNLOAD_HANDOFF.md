...
| 제품 버전 | `1.3.1` |
| macOS 빌드 번호 | `6` |
| 표시 이름 | `MonglePet macOS 1.3.1 Preview 1` |
| Git 태그 | `macos-v1.3.1-preview.1` |
| 기준 커밋 | `89ceb5444478eeb2717ac29ec930f4661503a794` |
| 게시일 | 2026-08-24 |
| ZIP 파일 | `MonglePet-1.3.1-build.6-preview.zip` |
| ZIP 크기 | 7,413,980 bytes (약 7.07 MiB) |
| ZIP SHA-256 | `BD0E59171DE502AC123ABE71F8EDD73D4C12A938D65A06186B644F2C8761CC04` |
| 서명·공증 상태 | Developer ID 미서명·Apple 미공증 Preview |
| 제공 범위 | 제한된 테스터용 |

- 릴리스 페이지: <https://github.com/saehajoo/MonglePet/releases/tag/macos-v1.3.1-preview.1>
- ZIP 직접 다운로드: <https://github.com/saehajoo/MonglePet/releases/download/macos-v1.3.1-preview.1/MonglePet-1.3.1-build.6-preview.zip>
- 체크섬 파일: <https://github.com/saehajoo/MonglePet/releases/download/macos-v1.3.1-preview.1/MonglePet-1.3.1-build.6-preview.zip.sha256>
- 빌드 manifest: <https://github.com/saehajoo/MonglePet/releases/download/macos-v1.3.1-preview.1/MonglePet-1.3.1-build.6-preview.manifest.txt>
...
```markdown
## MonglePet macOS 1.3.1 Preview 1

새 기본 몽글이와 확대·뒤집기·복사·추가 기능에 더해 결과 경계와 고정 미리보기를 다듬은 스프라이트 시트·PNG crop 편집을 제공하는 MonglePet macOS `1.3.1 (6)` 미서명·미공증 Preview입니다. 현재 파일은 제한된 테스터용으로 제공합니다.

[macOS용 Preview ZIP 다운로드](https://github.com/saehajoo/MonglePet/releases/download/macos-v1.3.1-preview.1/MonglePet-1.3.1-build.6-preview.zip)

- 지원 환경: macOS 14 이상, Apple Silicon 및 Intel Mac
- 파일 크기: 약 7.07 MiB
- 버전: 1.3.1 (6)
- SHA-256: `BD0E59171DE502AC123ABE71F8EDD73D4C12A938D65A06186B644F2C8761CC04`
...
[릴리스 정보·체크섬·빌드 manifest 보기](https://github.com/saehajoo/MonglePet/releases/tag/macos-v1.3.1-preview.1)
```
...
<section aria-labelledby="monglepet-macos-preview-title">
  <h2 id="monglepet-macos-preview-title">MonglePet macOS 1.3.1 Preview 1</h2>
  <p>미서명·미공증 상태로 제공하는 제한된 테스터용 Preview입니다.</p>
  <p>
    <a href="https://github.com/saehajoo/MonglePet/releases/download/macos-v1.3.1-preview.1/MonglePet-1.3.1-build.6-preview.zip">
      macOS용 Preview ZIP 다운로드
    </a>
  </p>
  <ul>
    <li>macOS 14 이상 · Apple Silicon 및 Intel Mac</li>
    <li>버전 1.3.1 (6) · 약 7.07 MiB</li>
    <li>Developer ID 미서명 · Apple 미공증</li>
  </ul>
  <p>
    SHA-256:
    <code>BD0E59171DE502AC123ABE71F8EDD73D4C12A938D65A06186B644F2C8761CC04</code>
  </p>
  <p>
  ...
  <p>
    <a href="https://github.com/saehajoo/MonglePet/releases/tag/macos-v1.3.1-preview.1">
...
```sh
shasum -a 256 \
  "$HOME/Downloads/MonglePet-1.3.1-build.6-preview.zip"
```

출력된 값이 아래 값과 정확히 같아야 한다.

```text
BD0E59171DE502AC123ABE71F8EDD73D4C12A938D65A06186B644F2C8761CC04
```
