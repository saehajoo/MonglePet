...
| 제품 버전 | `1.3.2` |
| macOS 빌드 번호 | `7` |
| 표시 이름 | `MonglePet macOS 1.3.2 Preview 1` |
| Git 태그 | `macos-v1.3.2-preview.1` |
| 기준 커밋 | `8cae849167d71daa28566e930167e3e11e00201d` |
| 게시일 | 2026-08-25 |
| ZIP 파일 | `MonglePet-1.3.2-build.7-preview.zip` |
| ZIP 크기 | 7,430,815 bytes (약 7.09 MiB) |
| ZIP SHA-256 | `96617B60E5187EB0DEB16088AB2706A572B0EE750C6ADB55B494B9EE40A0B6CD` |
| 서명·공증 상태 | Developer ID 미서명·Apple 미공증 Preview |
| 제공 범위 | 제한된 테스터용 |

- 릴리스 페이지: <https://github.com/saehajoo/MonglePet/releases/tag/macos-v1.3.2-preview.1>
- ZIP 직접 다운로드: <https://github.com/saehajoo/MonglePet/releases/download/macos-v1.3.2-preview.1/MonglePet-1.3.2-build.7-preview.zip>
- 체크섬 파일: <https://github.com/saehajoo/MonglePet/releases/download/macos-v1.3.2-preview.1/MonglePet-1.3.2-build.7-preview.zip.sha256>
- 빌드 manifest: <https://github.com/saehajoo/MonglePet/releases/download/macos-v1.3.2-preview.1/MonglePet-1.3.2-build.7-preview.manifest.txt>
...
```markdown
## MonglePet macOS 1.3.2 Preview 1

새 기본 몽글이와 다듬어진 PNG·스프라이트 편집 기능에 더해 이동 동작을 그대로 유지하며 런타임 CPU 비용을 보완한 MonglePet macOS `1.3.2 (7)` 미서명·미공증 Preview입니다. 현재 파일은 제한된 테스터용으로 제공합니다.

[macOS용 Preview ZIP 다운로드](https://github.com/saehajoo/MonglePet/releases/download/macos-v1.3.2-preview.1/MonglePet-1.3.2-build.7-preview.zip)

- 지원 환경: macOS 14 이상, Apple Silicon 및 Intel Mac
- 파일 크기: 약 7.09 MiB
- 버전: 1.3.2 (7)
- SHA-256: `96617B60E5187EB0DEB16088AB2706A572B0EE750C6ADB55B494B9EE40A0B6CD`
...
[릴리스 정보·체크섬·빌드 manifest 보기](https://github.com/saehajoo/MonglePet/releases/tag/macos-v1.3.2-preview.1)
```
...
<section aria-labelledby="monglepet-macos-preview-title">
  <h2 id="monglepet-macos-preview-title">MonglePet macOS 1.3.2 Preview 1</h2>
  <p>미서명·미공증 상태로 제공하는 제한된 테스터용 Preview입니다.</p>
  <p>
    <a href="https://github.com/saehajoo/MonglePet/releases/download/macos-v1.3.2-preview.1/MonglePet-1.3.2-build.7-preview.zip">
      macOS용 Preview ZIP 다운로드
    </a>
  </p>
  <ul>
    <li>macOS 14 이상 · Apple Silicon 및 Intel Mac</li>
    <li>버전 1.3.2 (7) · 약 7.09 MiB</li>
    <li>Developer ID 미서명 · Apple 미공증</li>
  </ul>
  <p>
    SHA-256:
    <code>96617B60E5187EB0DEB16088AB2706A572B0EE750C6ADB55B494B9EE40A0B6CD</code>
  </p>
  <p>
  ...
  <p>
    <a href="https://github.com/saehajoo/MonglePet/releases/tag/macos-v1.3.2-preview.1">
...
```sh
shasum -a 256 \
  "$HOME/Downloads/MonglePet-1.3.2-build.7-preview.zip"
```

출력된 값이 아래 값과 정확히 같아야 한다.

```text
96617B60E5187EB0DEB16088AB2706A572B0EE750C6ADB55B494B9EE40A0B6CD
```
...
4. 자체 서버에 파일을 복제한다면 공개 URL에서 다시 내려받아 Windows 64,866,058 bytes, macOS 7,430,815 bytes와 각 SHA-256을 확인한다.
