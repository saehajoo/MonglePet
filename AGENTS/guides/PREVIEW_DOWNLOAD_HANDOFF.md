...
| --- | --- |
| 제품 버전 | `1.1.0` |
| Windows 파일 버전 | `1.1.0.13` |
| 표시 이름 | `MonglePet Windows 1.1.0 Preview 1` |
| Git 태그 | `windows-v1.1.0-preview.1` |
| 기준 커밋 | `537d0b18ed38491ff17bf6fb590260231270bd5c` |
| 게시일 | 2026-08-16 |
| 설치기 파일 | `MonglePet-Windows-1.1.0.13-x64-Setup.exe` |
| 설치기 크기 | 63,829,785 bytes (약 60.87 MiB) |
| 설치기 SHA-256 | `4E1572A58440B8450081B7F4FA90B182D9EF4414BA40F802749139D733E55AF7` |
| 서명 상태 | 미서명 Preview |
| 업데이트 방식 | 새 설치기를 내려받아 기존 설치 위에 수동 설치 |

- 릴리스 페이지: <https://github.com/saehajoo/MonglePet/releases/tag/windows-v1.1.0-preview.1>
- 설치기 직접 다운로드: <https://github.com/saehajoo/MonglePet/releases/download/windows-v1.1.0-preview.1/MonglePet-Windows-1.1.0.13-x64-Setup.exe>
- 체크섬 파일: <https://github.com/saehajoo/MonglePet/releases/download/windows-v1.1.0-preview.1/SHA256SUMS.txt>
...
```markdown
## MonglePet Windows 1.1.0 Preview 1

여러 펫을 동시에 실행하고 각 펫의 위치, 이동, 행동과 말풍선 설정을 독립적으로 관리할 수 있는 Windows Preview입니다.

[Windows용 설치기 다운로드](https://github.com/saehajoo/MonglePet/releases/download/windows-v1.1.0-preview.1/MonglePet-Windows-1.1.0.13-x64-Setup.exe)

- 지원 환경: Windows 11 25H2 build 26200 이상, x64
- 파일 크기: 약 60.87 MiB
- 버전: 1.1.0.13
- SHA-256: `4E1572A58440B8450081B7F4FA90B182D9EF4414BA40F802749139D733E55AF7`
...
[릴리스 정보와 체크섬 보기](https://github.com/saehajoo/MonglePet/releases/tag/windows-v1.1.0-preview.1)
```
...
<section aria-labelledby="monglepet-windows-preview-title">
  <h2 id="monglepet-windows-preview-title">MonglePet Windows 1.1.0 Preview 1</h2>
  <p>
    여러 펫의 위치, 이동, 행동과 말풍선 설정을 독립적으로 관리할 수 있는
    Windows Preview입니다.
  </p>
  <p>
    <a href="https://github.com/saehajoo/MonglePet/releases/download/windows-v1.1.0-preview.1/MonglePet-Windows-1.1.0.13-x64-Setup.exe">
      Windows용 설치기 다운로드
    </a>
  </p>
  <ul>
    <li>Windows 11 25H2 build 26200 이상, x64</li>
    <li>버전 1.1.0.13 · 약 60.87 MiB</li>
    <li>미서명 Preview · 수동 업데이트</li>
  </ul>
  <p>
    SHA-256:
    <code>4E1572A58440B8450081B7F4FA90B182D9EF4414BA40F802749139D733E55AF7</code>
  </p>
  <p>
  ...
  <p>
    <a href="https://github.com/saehajoo/MonglePet/releases/tag/windows-v1.1.0-preview.1">
      릴리스 정보와 체크섬 보기
    </a>
  </p>
</section>
...
```powershell
Get-FileHash `
    "$env:USERPROFILE\Downloads\MonglePet-Windows-1.1.0.13-x64-Setup.exe" `
    -Algorithm SHA256
```
...
```text
4E1572A58440B8450081B7F4FA90B182D9EF4414BA40F802749139D733E55AF7
```
