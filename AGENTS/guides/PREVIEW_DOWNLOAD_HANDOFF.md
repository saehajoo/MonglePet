...
| 제품 버전 | `1.3.0` |
| macOS 빌드 번호 | `5` |
| 표시 이름 | `MonglePet macOS 1.3.0 Preview 1` |
| Git 태그 | `macos-v1.3.0-preview.1` |
| 기준 커밋 | `bf7874b3ef197f2badbe5fc8f3060864dda38843` |
| 게시일 | 2026-08-24 |
| ZIP 파일 | `MonglePet-1.3.0-build.5-preview.zip` |
| ZIP 크기 | 7,334,062 bytes (약 6.99 MiB) |
| ZIP SHA-256 | `187629C944C4FAD36AC21548413B212EE9F2ED16CF669B84559BDD9C3CEE6B5F` |
| 서명·공증 상태 | Developer ID 미서명·Apple 미공증 Preview |
| 제공 범위 | 제한된 테스터용 |

- 릴리스 페이지: <https://github.com/saehajoo/MonglePet/releases/tag/macos-v1.3.0-preview.1>
- ZIP 직접 다운로드: <https://github.com/saehajoo/MonglePet/releases/download/macos-v1.3.0-preview.1/MonglePet-1.3.0-build.5-preview.zip>
- 체크섬 파일: <https://github.com/saehajoo/MonglePet/releases/download/macos-v1.3.0-preview.1/MonglePet-1.3.0-build.5-preview.zip.sha256>
- 빌드 manifest: <https://github.com/saehajoo/MonglePet/releases/download/macos-v1.3.0-preview.1/MonglePet-1.3.0-build.5-preview.manifest.txt>
...
```markdown
## MonglePet macOS 1.3.0 Preview 1

새 기본 몽글이와 확대·뒤집기·복사·추가 기능을 갖춘 스프라이트 시트·PNG crop 편집을 제공하는 MonglePet macOS `1.3.0 (5)` 미서명·미공증 Preview입니다. 현재 파일은 제한된 테스터용으로 제공합니다.

[macOS용 Preview ZIP 다운로드](https://github.com/saehajoo/MonglePet/releases/download/macos-v1.3.0-preview.1/MonglePet-1.3.0-build.5-preview.zip)

- 지원 환경: macOS 14 이상, Apple Silicon 및 Intel Mac
- 파일 크기: 약 6.99 MiB
- 버전: 1.3.0 (5)
- SHA-256: `187629C944C4FAD36AC21548413B212EE9F2ED16CF669B84559BDD9C3CEE6B5F`
...
[릴리스 정보·체크섬·빌드 manifest 보기](https://github.com/saehajoo/MonglePet/releases/tag/macos-v1.3.0-preview.1)
```
...
<section aria-labelledby="monglepet-macos-preview-title">
  <h2 id="monglepet-macos-preview-title">MonglePet macOS 1.3.0 Preview 1</h2>
  <p>미서명·미공증 상태로 제공하는 제한된 테스터용 Preview입니다.</p>
  <p>
    <a href="https://github.com/saehajoo/MonglePet/releases/download/macos-v1.3.0-preview.1/MonglePet-1.3.0-build.5-preview.zip">
      macOS용 Preview ZIP 다운로드
    </a>
  </p>
  <ul>
    <li>macOS 14 이상 · Apple Silicon 및 Intel Mac</li>
    <li>버전 1.3.0 (5) · 약 6.99 MiB</li>
    <li>Developer ID 미서명 · Apple 미공증</li>
  </ul>
  <p>
    SHA-256:
    <code>187629C944C4FAD36AC21548413B212EE9F2ED16CF669B84559BDD9C3CEE6B5F</code>
  </p>
  <p>
  ...
  <p>
    <a href="https://github.com/saehajoo/MonglePet/releases/tag/macos-v1.3.0-preview.1">
...
```sh
shasum -a 256 \
  "$HOME/Downloads/MonglePet-1.3.0-build.5-preview.zip"
```

출력된 값이 아래 값과 정확히 같아야 한다.

```text
187629C944C4FAD36AC21548413B212EE9F2ED16CF669B84559BDD9C3CEE6B5F
```
...
4. 자체 서버에 파일을 복제한다면 공개 URL에서 다시 내려받아 Windows 63,847,413 bytes, macOS 7,334,062 bytes와 각 SHA-256을 확인한다.
