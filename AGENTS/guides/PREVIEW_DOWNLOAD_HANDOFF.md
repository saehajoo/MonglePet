...
| 제품 버전 | `1.8.2` |
| macOS 빌드 번호 | `18` |
| 표시 이름 | `MonglePet macOS 1.8.2 Preview 1` |
| Git 태그 | `macos-v1.8.2-preview.1` |
| 기준 커밋 | `b2cad6ffe8ba8a7f065296e0644460154faa9905` |
| 게시일 | 2026-09-06 |
| ZIP 파일 | `MonglePet-1.8.2-build.18-preview.zip` |
| ZIP 크기 | 11,352,823 bytes (약 10.83 MiB) |
| ZIP SHA-256 | `134A09811AC38873C0E99966DAD43DF160DCCDE87B147C015D1E0A4933D417AD` |
| 서명·공증 상태 | Developer ID 미서명·Apple 미공증 Preview |
| 제공 범위 | 제한된 테스터용 |

- 릴리스 페이지: <https://github.com/saehajoo/MonglePet/releases/tag/macos-v1.8.2-preview.1>
- ZIP 직접 다운로드: <https://github.com/saehajoo/MonglePet/releases/download/macos-v1.8.2-preview.1/MonglePet-1.8.2-build.18-preview.zip>
- 체크섬 파일: <https://github.com/saehajoo/MonglePet/releases/download/macos-v1.8.2-preview.1/MonglePet-1.8.2-build.18-preview.zip.sha256>
- 빌드 manifest: <https://github.com/saehajoo/MonglePet/releases/download/macos-v1.8.2-preview.1/MonglePet-1.8.2-build.18-preview.manifest.txt>
...
```markdown
## MonglePet macOS 1.8.2 Preview 1

새 펫·애니메이션·PNG·스프라이트·현재 프레임·말풍선 편집을 크기 조절 가능한 독립 창으로 제공하고, 현재 메인 창이나 바로 이전 편집 창 근처의 작업 영역 안에 안전하게 여는 MonglePet macOS `1.8.2 (18)` 미서명·미공증 Preview입니다. 애니메이션 반복 힌트 비노출과 행동 연결 우선 편집도 포함합니다. 현재 파일은 제한된 테스터용으로 제공합니다.

[macOS용 Preview ZIP 다운로드](https://github.com/saehajoo/MonglePet/releases/download/macos-v1.8.2-preview.1/MonglePet-1.8.2-build.18-preview.zip)
...
[릴리스 정보·체크섬·빌드 manifest 보기](https://github.com/saehajoo/MonglePet/releases/tag/macos-v1.8.2-preview.1)
```
...
<section aria-labelledby="monglepet-macos-preview-title">
  <h2 id="monglepet-macos-preview-title">MonglePet macOS 1.8.2 Preview 1</h2>
  <p>미서명·미공증 상태로 제공하는 제한된 테스터용 Preview입니다.</p>
  <p>
    <a href="https://github.com/saehajoo/MonglePet/releases/download/macos-v1.8.2-preview.1/MonglePet-1.8.2-build.18-preview.zip">
      macOS용 Preview ZIP 다운로드
    </a>
  </p>
  <ul>
    <li>macOS 14 이상 · Apple Silicon 및 Intel Mac</li>
    <li>버전 1.8.2 (18) · 약 10.83 MiB</li>
    <li>Developer ID 미서명 · Apple 미공증</li>
  </ul>
  <p>
    SHA-256:
    <code>134A09811AC38873C0E99966DAD43DF160DCCDE87B147C015D1E0A4933D417AD</code>
  </p>
  <p>
  ...
  <p>
    <a href="https://github.com/saehajoo/MonglePet/releases/tag/macos-v1.8.2-preview.1">
...
```sh
shasum -a 256 \
  "$HOME/Downloads/MonglePet-1.8.2-build.18-preview.zip"
```

출력된 값이 아래 값과 정확히 같아야 한다.

```text
134A09811AC38873C0E99966DAD43DF160DCCDE87B147C015D1E0A4933D417AD
```
...
4. 자체 서버에 파일을 복제한다면 공개 URL에서 다시 내려받아 Windows 65,284,301 bytes, macOS 11,352,823 bytes와 각 SHA-256을 확인한다.
