...
| --- | --- |
| 제품 버전 | `1.6.0` |
| Windows 파일 버전 | `1.6.0.18` |
| 표시 이름 | `MonglePet Windows 1.6.0 Preview 4` |
| Git 태그 | `windows-v1.6.0-preview.4` |
| 기준 커밋 | `69e4aaa0a41133ea6315e58640a8e017d5e42bed` |
| 게시일 | 2026-09-04 |
| 설치기 파일 | `MonglePet-Windows-1.6.0.18-x64-Setup.exe` |
| 설치기 크기 | 65,276,445 bytes (약 62.25 MiB) |
| 설치기 SHA-256 | `B3ADF59C87924EBC75197009511BBC9BF98EA5BCD4591334AE98EC06E7D679D9` |
| 서명 상태 | 미서명 Preview |
| 업데이트 방식 | 새 설치기를 내려받아 기존 설치 위에 수동 설치 |

- 릴리스 페이지: <https://github.com/saehajoo/MonglePet/releases/tag/windows-v1.6.0-preview.4>
- 설치기 직접 다운로드: <https://github.com/saehajoo/MonglePet/releases/download/windows-v1.6.0-preview.4/MonglePet-Windows-1.6.0.18-x64-Setup.exe>
- 체크섬 파일: <https://github.com/saehajoo/MonglePet/releases/download/windows-v1.6.0-preview.4/SHA256SUMS.txt>
...
| 제품 버전 | `1.7.0` |
| macOS 빌드 번호 | `15` |
| 표시 이름 | `MonglePet macOS 1.7.0 Preview 1` |
| Git 태그 | `macos-v1.7.0-preview.1` |
| 기준 커밋 | `daa59dcdb7d9ce54f18014e14776069ef772054b` |
| 게시일 | 2026-09-05 |
| ZIP 파일 | `MonglePet-1.7.0-build.15-preview.zip` |
| ZIP 크기 | 11,005,258 bytes (약 10.50 MiB) |
| ZIP SHA-256 | `BFBCFFA0290DD298DF5D58F4F5EFAAABE20B92F86F7E2059A276404CDCEEF40D` |
| 서명·공증 상태 | Developer ID 미서명·Apple 미공증 Preview |
| 제공 범위 | 제한된 테스터용 |

- 릴리스 페이지: <https://github.com/saehajoo/MonglePet/releases/tag/macos-v1.7.0-preview.1>
- ZIP 직접 다운로드: <https://github.com/saehajoo/MonglePet/releases/download/macos-v1.7.0-preview.1/MonglePet-1.7.0-build.15-preview.zip>
- 체크섬 파일: <https://github.com/saehajoo/MonglePet/releases/download/macos-v1.7.0-preview.1/MonglePet-1.7.0-build.15-preview.zip.sha256>
- 빌드 manifest: <https://github.com/saehajoo/MonglePet/releases/download/macos-v1.7.0-preview.1/MonglePet-1.7.0-build.15-preview.manifest.txt>
...
- 웹의 `MonglePet에 추가`가 반응하지 않으면 브라우저의 외부 앱 실행 허용을 확인하고
  재시도하거나 `.monglepet` 파일을 내려받아 앱의 `펫 가져오기`를 사용하도록 안내
...
```markdown
## MonglePet Windows 1.6.0 Preview 4

로컬·웹 가져오기를 단일 `펫 추가`로 통합하고 제작자의 행동·이동·말풍선·표시 설정을 새 펫에 자동 적용하는 Windows Preview입니다. 웹 프로토콜 등록과 실행 중 앱의 전면 전환도 보강했으며 기존 schema-v15 설정과 펫은 그대로 유지됩니다.

[Windows용 설치기 다운로드](https://github.com/saehajoo/MonglePet/releases/download/windows-v1.6.0-preview.4/MonglePet-Windows-1.6.0.18-x64-Setup.exe)

- 지원 환경: Windows 11 25H2 build 26200 이상, x64
- 파일 크기: 약 62.25 MiB
- 버전: 1.6.0.18
- SHA-256: `B3ADF59C87924EBC75197009511BBC9BF98EA5BCD4591334AE98EC06E7D679D9`
...
[릴리스 정보와 체크섬 보기](https://github.com/saehajoo/MonglePet/releases/tag/windows-v1.6.0-preview.4)
```

```markdown
## MonglePet macOS 1.7.0 Preview 1

자유 이동과 마우스 도망가기의 평상시 자유 이동에 `행동 완료 후` 시간 방식을 추가한 MonglePet macOS `1.7.0 (15)` 미서명·미공증 Preview입니다. 현재 행동 한 회차를 마친 뒤 이동하며 두 이동 방식의 설정은 독립적으로 저장됩니다. 현재 파일은 제한된 테스터용으로 제공합니다.

[macOS용 Preview ZIP 다운로드](https://github.com/saehajoo/MonglePet/releases/download/macos-v1.7.0-preview.1/MonglePet-1.7.0-build.15-preview.zip)

- 지원 환경: macOS 14 이상, Apple Silicon 및 Intel Mac
- 파일 크기: 약 10.50 MiB
- 버전: 1.7.0 (15)
- SHA-256: `BFBCFFA0290DD298DF5D58F4F5EFAAABE20B92F86F7E2059A276404CDCEEF40D`
...
[릴리스 정보·체크섬·빌드 manifest 보기](https://github.com/saehajoo/MonglePet/releases/tag/macos-v1.7.0-preview.1)
```
...
<section aria-labelledby="monglepet-windows-preview-title">
  <h2 id="monglepet-windows-preview-title">MonglePet Windows 1.6.0 Preview 4</h2>
  <p>
    단일 펫 추가와 제작자 설정 자동 적용, 웹 프로토콜 등록과
    실행 중 앱의 전면 전환을 보강한 Windows Preview입니다.
  </p>
  <p>
    <a href="https://github.com/saehajoo/MonglePet/releases/download/windows-v1.6.0-preview.4/MonglePet-Windows-1.6.0.18-x64-Setup.exe">
      Windows용 설치기 다운로드
    </a>
  </p>
  <ul>
    <li>Windows 11 25H2 build 26200 이상, x64</li>
    <li>버전 1.6.0.18 · 약 62.25 MiB</li>
    <li>미서명 Preview · 수동 업데이트</li>
  </ul>
  <p>
    SHA-256:
    <code>B3ADF59C87924EBC75197009511BBC9BF98EA5BCD4591334AE98EC06E7D679D9</code>
  </p>
  <p>
  ...
  <p>
    <a href="https://github.com/saehajoo/MonglePet/releases/tag/windows-v1.6.0-preview.4">
      릴리스 정보와 체크섬 보기
    </a>
  </p>
</section>
...
<section aria-labelledby="monglepet-macos-preview-title">
  <h2 id="monglepet-macos-preview-title">MonglePet macOS 1.7.0 Preview 1</h2>
  <p>미서명·미공증 상태로 제공하는 제한된 테스터용 Preview입니다.</p>
  <p>
    <a href="https://github.com/saehajoo/MonglePet/releases/download/macos-v1.7.0-preview.1/MonglePet-1.7.0-build.15-preview.zip">
      macOS용 Preview ZIP 다운로드
    </a>
  </p>
  <ul>
    <li>macOS 14 이상 · Apple Silicon 및 Intel Mac</li>
    <li>버전 1.7.0 (15) · 약 10.50 MiB</li>
    <li>Developer ID 미서명 · Apple 미공증</li>
  </ul>
  <p>
    SHA-256:
    <code>BFBCFFA0290DD298DF5D58F4F5EFAAABE20B92F86F7E2059A276404CDCEEF40D</code>
  </p>
  <p>
  ...
  <p>
    <a href="https://github.com/saehajoo/MonglePet/releases/tag/macos-v1.7.0-preview.1">
...
```powershell
Get-FileHash `
    "$env:USERPROFILE\Downloads\MonglePet-Windows-1.6.0.18-x64-Setup.exe" `
    -Algorithm SHA256
```
...
```text
B3ADF59C87924EBC75197009511BBC9BF98EA5BCD4591334AE98EC06E7D679D9
```
...
```sh
shasum -a 256 \
  "$HOME/Downloads/MonglePet-1.7.0-build.15-preview.zip"
```

출력된 값이 아래 값과 정확히 같아야 한다.

```text
BFBCFFA0290DD298DF5D58F4F5EFAAABE20B92F86F7E2059A276404CDCEEF40D
```
...
4. 자체 서버에 파일을 복제한다면 공개 URL에서 다시 내려받아 Windows 65,276,445 bytes, macOS 11,005,258 bytes와 각 SHA-256을 확인한다.
