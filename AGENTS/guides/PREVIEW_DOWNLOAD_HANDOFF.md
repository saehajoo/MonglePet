...
| --- | --- |
| 제품 버전 | `1.5.0` |
| Windows 파일 버전 | `1.5.0.15` |
| 표시 이름 | `MonglePet Windows 1.5.0 Preview 1` |
| Git 태그 | `windows-v1.5.0-preview.1` |
| 기준 커밋 | `f60738bd957d6bfb0cc1ccb401ebd5044254a317` |
| 게시일 | 2026-08-30 |
| 설치기 파일 | `MonglePet-Windows-1.5.0.15-x64-Setup.exe` |
| 설치기 크기 | 65,264,291 bytes (약 62.24 MiB) |
| 설치기 SHA-256 | `A3BA47C263047640E2A3EC9281BE6DD33A0615D02618205E011F9D0809FC0ECE` |
| 서명 상태 | 미서명 Preview |
| 업데이트 방식 | 새 설치기를 내려받아 기존 설치 위에 수동 설치 |

- 릴리스 페이지: <https://github.com/saehajoo/MonglePet/releases/tag/windows-v1.5.0-preview.1>
- 설치기 직접 다운로드: <https://github.com/saehajoo/MonglePet/releases/download/windows-v1.5.0-preview.1/MonglePet-Windows-1.5.0.15-x64-Setup.exe>
- 체크섬 파일: <https://github.com/saehajoo/MonglePet/releases/download/windows-v1.5.0-preview.1/SHA256SUMS.txt>
...
| 제품 버전 | `1.5.0` |
| macOS 빌드 번호 | `11` |
| 표시 이름 | `MonglePet macOS 1.5.0 Preview 1` |
| Git 태그 | `macos-v1.5.0-preview.1` |
| 기준 커밋 | `80b01678b41c0b80df5f5ad44d5df8987d908b09` |
| 게시일 | 2026-08-30 |
| ZIP 파일 | `MonglePet-1.5.0-build.11-preview.zip` |
| ZIP 크기 | 10,944,162 bytes (약 10.44 MiB) |
| ZIP SHA-256 | `43D375F6B1463BC3EBE9845B284C24C02AE796406258D4149ABA60E153A74838` |
| 서명·공증 상태 | Developer ID 미서명·Apple 미공증 Preview |
| 제공 범위 | 제한된 테스터용 |

- 릴리스 페이지: <https://github.com/saehajoo/MonglePet/releases/tag/macos-v1.5.0-preview.1>
- ZIP 직접 다운로드: <https://github.com/saehajoo/MonglePet/releases/download/macos-v1.5.0-preview.1/MonglePet-1.5.0-build.11-preview.zip>
- 체크섬 파일: <https://github.com/saehajoo/MonglePet/releases/download/macos-v1.5.0-preview.1/MonglePet-1.5.0-build.11-preview.zip.sha256>
- 빌드 manifest: <https://github.com/saehajoo/MonglePet/releases/download/macos-v1.5.0-preview.1/MonglePet-1.5.0-build.11-preview.manifest.txt>
...
```markdown
## MonglePet Windows 1.5.0 Preview 1

평상시 행동을 하나 선택·랜덤 선택으로 단순화하고 조건 규칙을 독립 분리한 schema-v15·권장 프로필 v11 Windows Preview입니다. 기존 설정은 자동 이관되며 마우스 도망가기 평상시 자유 이동과 랜덤 행동 전환도 보완했습니다.

[Windows용 설치기 다운로드](https://github.com/saehajoo/MonglePet/releases/download/windows-v1.5.0-preview.1/MonglePet-Windows-1.5.0.15-x64-Setup.exe)

- 지원 환경: Windows 11 25H2 build 26200 이상, x64
- 파일 크기: 약 62.24 MiB
- 버전: 1.5.0.15
- SHA-256: `A3BA47C263047640E2A3EC9281BE6DD33A0615D02618205E011F9D0809FC0ECE`
...
[릴리스 정보와 체크섬 보기](https://github.com/saehajoo/MonglePet/releases/tag/windows-v1.5.0-preview.1)
```

```markdown
## MonglePet macOS 1.5.0 Preview 1

평상시 고정·랜덤 행동 선택과 조건 규칙을 분리하고, 설정 schema-v15·권장 프로필 v11 및 가져오기·내보내기 내용 확인을 정리한 MonglePet macOS `1.5.0 (11)` 미서명·미공증 Preview입니다. 현재 파일은 제한된 테스터용으로 제공합니다.

[macOS용 Preview ZIP 다운로드](https://github.com/saehajoo/MonglePet/releases/download/macos-v1.5.0-preview.1/MonglePet-1.5.0-build.11-preview.zip)

- 지원 환경: macOS 14 이상, Apple Silicon 및 Intel Mac
- 파일 크기: 약 10.44 MiB
- 버전: 1.5.0 (11)
- SHA-256: `43D375F6B1463BC3EBE9845B284C24C02AE796406258D4149ABA60E153A74838`
...
[릴리스 정보·체크섬·빌드 manifest 보기](https://github.com/saehajoo/MonglePet/releases/tag/macos-v1.5.0-preview.1)
```
...
<section aria-labelledby="monglepet-windows-preview-title">
  <h2 id="monglepet-windows-preview-title">MonglePet Windows 1.5.0 Preview 1</h2>
  <p>
    평상시 행동과 조건 규칙을 분리하고 schema-v15·권장 프로필 v11,
    랜덤 행동 전환과 마우스 도망가기 이동을 보완한 Windows Preview입니다.
  </p>
  <p>
    <a href="https://github.com/saehajoo/MonglePet/releases/download/windows-v1.5.0-preview.1/MonglePet-Windows-1.5.0.15-x64-Setup.exe">
      Windows용 설치기 다운로드
    </a>
  </p>
  <ul>
    <li>Windows 11 25H2 build 26200 이상, x64</li>
    <li>버전 1.5.0.15 · 약 62.24 MiB</li>
    <li>미서명 Preview · 수동 업데이트</li>
  </ul>
  <p>
    SHA-256:
    <code>A3BA47C263047640E2A3EC9281BE6DD33A0615D02618205E011F9D0809FC0ECE</code>
  </p>
  <p>
  ...
  <p>
    <a href="https://github.com/saehajoo/MonglePet/releases/tag/windows-v1.5.0-preview.1">
      릴리스 정보와 체크섬 보기
    </a>
  </p>
</section>
...
<section aria-labelledby="monglepet-macos-preview-title">
  <h2 id="monglepet-macos-preview-title">MonglePet macOS 1.5.0 Preview 1</h2>
  <p>미서명·미공증 상태로 제공하는 제한된 테스터용 Preview입니다.</p>
  <p>
    <a href="https://github.com/saehajoo/MonglePet/releases/download/macos-v1.5.0-preview.1/MonglePet-1.5.0-build.11-preview.zip">
      macOS용 Preview ZIP 다운로드
    </a>
  </p>
  <ul>
    <li>macOS 14 이상 · Apple Silicon 및 Intel Mac</li>
    <li>버전 1.5.0 (11) · 약 10.44 MiB</li>
    <li>Developer ID 미서명 · Apple 미공증</li>
  </ul>
  <p>
    SHA-256:
    <code>43D375F6B1463BC3EBE9845B284C24C02AE796406258D4149ABA60E153A74838</code>
  </p>
  <p>
  ...
  <p>
    <a href="https://github.com/saehajoo/MonglePet/releases/tag/macos-v1.5.0-preview.1">
...
```powershell
Get-FileHash `
    "$env:USERPROFILE\Downloads\MonglePet-Windows-1.5.0.15-x64-Setup.exe" `
    -Algorithm SHA256
```
...
```text
A3BA47C263047640E2A3EC9281BE6DD33A0615D02618205E011F9D0809FC0ECE
```
...
```sh
shasum -a 256 \
  "$HOME/Downloads/MonglePet-1.5.0-build.11-preview.zip"
```

출력된 값이 아래 값과 정확히 같아야 한다.

```text
43D375F6B1463BC3EBE9845B284C24C02AE796406258D4149ABA60E153A74838
```
...
4. 자체 서버에 파일을 복제한다면 공개 URL에서 다시 내려받아 Windows 65,264,291 bytes, macOS 10,944,162 bytes와 각 SHA-256을 확인한다.
5. 브라우저에서 실제 다운로드한 파일명이 원본 설치기 또는 ZIP 이름과 같은지 확인한다.
6. Windows는 기존 `1.4.0.14` 위 업데이트와 데이터 보존을, macOS는 ZIP 해제·응용 프로그램 폴더 이동·시스템 설정의 개별 앱 승인 흐름을 표본 확인한다.
