...
| 제품 버전 | `1.6.0` |
| macOS 빌드 번호 | `14` |
| 표시 이름 | `MonglePet macOS 1.6.0 Preview 3` |
| Git 태그 | `macos-v1.6.0-preview.3` |
| 기준 커밋 | `b054e35d6ac3edc7cb18e44461bb8f870a6a40a5` |
| 게시일 | 2026-09-04 |
| ZIP 파일 | `MonglePet-1.6.0-build.14-preview.zip` |
| ZIP 크기 | 10,890,414 bytes (약 10.39 MiB) |
| ZIP SHA-256 | `B555B0FA03B7F95C7D6D545BAE929A9269605A2FDCF372A3FD039E5EB4F36EF2` |
| 서명·공증 상태 | Developer ID 미서명·Apple 미공증 Preview |
| 제공 범위 | 제한된 테스터용 |

- 릴리스 페이지: <https://github.com/saehajoo/MonglePet/releases/tag/macos-v1.6.0-preview.3>
- ZIP 직접 다운로드: <https://github.com/saehajoo/MonglePet/releases/download/macos-v1.6.0-preview.3/MonglePet-1.6.0-build.14-preview.zip>
- 체크섬 파일: <https://github.com/saehajoo/MonglePet/releases/download/macos-v1.6.0-preview.3/MonglePet-1.6.0-build.14-preview.zip.sha256>
- 빌드 manifest: <https://github.com/saehajoo/MonglePet/releases/download/macos-v1.6.0-preview.3/MonglePet-1.6.0-build.14-preview.manifest.txt>
...
```markdown
## MonglePet macOS 1.6.0 Preview 3

단일 `펫 추가`, 제작자 설정 자동 적용과 `펫 정보·애니메이션` 다음의 `행동 편집` 탐색 순서를 반영한 MonglePet macOS `1.6.0 (14)` 미서명·미공증 Preview입니다. 현재 파일은 제한된 테스터용으로 제공합니다.

[macOS용 Preview ZIP 다운로드](https://github.com/saehajoo/MonglePet/releases/download/macos-v1.6.0-preview.3/MonglePet-1.6.0-build.14-preview.zip)

- 지원 환경: macOS 14 이상, Apple Silicon 및 Intel Mac
- 파일 크기: 약 10.39 MiB
- 버전: 1.6.0 (14)
- SHA-256: `B555B0FA03B7F95C7D6D545BAE929A9269605A2FDCF372A3FD039E5EB4F36EF2`
...
[릴리스 정보·체크섬·빌드 manifest 보기](https://github.com/saehajoo/MonglePet/releases/tag/macos-v1.6.0-preview.3)
```
...
<section aria-labelledby="monglepet-macos-preview-title">
  <h2 id="monglepet-macos-preview-title">MonglePet macOS 1.6.0 Preview 3</h2>
  <p>미서명·미공증 상태로 제공하는 제한된 테스터용 Preview입니다.</p>
  <p>
    <a href="https://github.com/saehajoo/MonglePet/releases/download/macos-v1.6.0-preview.3/MonglePet-1.6.0-build.14-preview.zip">
      macOS용 Preview ZIP 다운로드
    </a>
  </p>
  <ul>
    <li>macOS 14 이상 · Apple Silicon 및 Intel Mac</li>
    <li>버전 1.6.0 (14) · 약 10.39 MiB</li>
    <li>Developer ID 미서명 · Apple 미공증</li>
  </ul>
  <p>
    SHA-256:
    <code>B555B0FA03B7F95C7D6D545BAE929A9269605A2FDCF372A3FD039E5EB4F36EF2</code>
  </p>
  <p>
  ...
  <p>
    <a href="https://github.com/saehajoo/MonglePet/releases/tag/macos-v1.6.0-preview.3">
...
```sh
shasum -a 256 \
  "$HOME/Downloads/MonglePet-1.6.0-build.14-preview.zip"
```

출력된 값이 아래 값과 정확히 같아야 한다.

```text
B555B0FA03B7F95C7D6D545BAE929A9269605A2FDCF372A3FD039E5EB4F36EF2
```
...
4. 자체 서버에 파일을 복제한다면 공개 URL에서 다시 내려받아 Windows 65,276,445 bytes, macOS 10,890,414 bytes와 각 SHA-256을 확인한다.
