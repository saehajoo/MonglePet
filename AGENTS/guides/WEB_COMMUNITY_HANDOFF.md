...
`Private Use`, 개인 용도 전용, `All Rights Reserved`, `Unknown`, 미지정 라이선스는 공개 게시를 자동 허용하지 않는다. 허용할 라이선스 목록과 사용자 정의 라이선스의 관리자 검토 정책을 웹 저장소에서 별도로 확정한다.
