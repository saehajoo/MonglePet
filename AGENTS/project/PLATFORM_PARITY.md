...
| 배포·업데이트 | 진행 중 | 진행 중 | macOS 1.2.0 (3) ZIP·SHA-256·manifest와 Windows 1.1.0.13 x64 설치기·SHA256SUMS를 각각 플랫폼별 GitHub Pre-release로 게시하고 원격 digest 검증 통과; 플랫폼별 최신 웹 전달 자료 작성 완료, 자체 웹 다운로드 화면 반영·서명·HTTPS·깨끗한 PC와 향후 자동 업데이트 QA 남음 |
