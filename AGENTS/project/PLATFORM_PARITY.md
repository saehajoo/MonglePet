...
| 배포·업데이트 | 진행 중 | 진행 중 | macOS 1.3.2 (7)와 Windows 1.3.0.13 GitHub Pre-release를 게시하고 원격 digest 검증을 통과했다. Windows 설치기는 미서명 x64 Preview이며 packaged/unpackaged 업데이트 데이터 보존·실행을 확인했다. 업데이트 확인·자동 업데이트는 D-087에 따라 보류 |
