...
| 멀티펫 | 진행 중 (`1.1.0`) | 계획됨 (`1.1.0`) | macOS schema-v11 Domain·원자적 저장, v1~v10 마이그레이션, 식별자·참조·순서 부분 복구와 공통 fixture 검증 완료; 다음은 독립 런타임 manager·다중 overlay이며 Windows는 macOS 인계 후 Windows 환경에서 반영 |
