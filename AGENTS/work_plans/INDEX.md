...
| 상태 | 작업명 | 파일 | 마지막 갱신 |
| --- | --- | --- | --- |
| in_progress | 펫 내보내기 무손실 PNG·WebP 최적화·30 MiB 상한 | `tasks/2026-09-07-pet-export-size-optimization.md` | 2026-09-07 |
...
| 상태 | 작업명 | 파일 | 완료일 |
| --- | --- | --- | --- |
| completed | Windows 1.8.2 애니메이션 편집기 Preview 릴리스 | `tasks/2026-09-07-windows-1-8-2-editor-release.md` | 2026-09-07 |
| completed | macOS 1.8.2 큰 제작 편집기 Preview 릴리스 | `tasks/2026-09-06-macos-1-8-2-editor-windows-release.md` | 2026-09-06 |
