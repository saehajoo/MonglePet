...
- [ ] 4단계: 소스 변경을 커밋·푸시하고 검증된 커밋에서 설치기를 생성한다.
- [ ] 5단계: 기존 설치 위 업데이트와 사용자 데이터 보존을 확인한다.
- [ ] 6단계: GitHub Pre-release를 게시하고 원격 산출물 digest를 재검증한다.

### 플랫폼 동등성

- [ ] 7단계: 배포·웹 다운로드 인계 문서와 플랫폼 현황을 최종 갱신한다.
