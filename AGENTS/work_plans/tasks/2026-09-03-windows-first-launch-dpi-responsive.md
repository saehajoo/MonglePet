...
- [x] macOS 공통 동작·저장 계약에 영향이 없음을 확인한다.
...
- 2026-09-03: 소스 커밋 `18b13f7e26e70bbd55cd103ac2bbd363dea4521d`와 annotated tag `windows-v1.6.0-preview.3`을 `origin/main`에 푸시하고 GitHub Pre-release를 게시했다. 65,273,031 bytes 설치기의 SHA-256은 `4BDA35324A7BDEEC829DD41B943D954A7268BABC7502B67613E88345B2305FA3`이며 원격 설치기와 107 bytes `SHA256SUMS.txt`를 다시 내려받아 로컬 산출물과 일치함을 확인했다.
- 2026-09-03: 최종 `1.6.0.17`을 기존 설치 위에 종료 코드 0으로 설치했다. `%LOCALAPPDATA%\MonglePet`의 48개·5,827,052 bytes와 inventory digest `12AEB5EC4658F5D66364FB3E7A10A390DA650F4F97CB91587AC253EC39F972D7`가 전후 같았고, 설치 DLL은 publish DLL과 일치하며 설치본 프로세스가 응답 중임을 확인했다.

## 완료 결과

- 코드 구현, Debug·Release 자동 검증, 설치 업데이트·데이터 보존과 GitHub Preview 3 게시를 완료했다. 실제 설치 완료 화면 첫 실행과 혼합 DPI 교차 모니터 QA는 후속 확인으로 남긴다.
