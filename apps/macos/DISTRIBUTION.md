...
- 최신 macOS `1.3.2 (7)` 이동 런타임 성능 보정 Preview는 태그 [`macos-v1.3.2-preview.1`](https://github.com/saehajoo/MonglePet/releases/tag/macos-v1.3.2-preview.1)로 게시했으며 ZIP·SHA-256·manifest의 원격 일치를 확인했습니다.
