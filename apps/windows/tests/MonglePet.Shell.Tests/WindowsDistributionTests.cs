...
public sealed class WindowsDistributionTests : IDisposable
{
    ...
    public void MarketingAssemblyFileAndPackageVersionsStayAligned()
    {
        ...
        Assert.Equal("1.9.2", ProjectProperty(project, "Version"));
        Assert.Equal("1.9.2.24", ProjectProperty(project, "AssemblyVersion"));
        Assert.Equal("1.9.2.24", ProjectProperty(project, "FileVersion"));
