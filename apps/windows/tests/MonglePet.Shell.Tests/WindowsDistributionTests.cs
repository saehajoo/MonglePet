...
public sealed class WindowsDistributionTests : IDisposable
{
    ...
    public void MarketingAssemblyFileAndPackageVersionsStayAligned()
    {
        ...
        Assert.Equal("1.5.0", ProjectProperty(project, "Version"));
        Assert.Equal("1.5.0.15", ProjectProperty(project, "AssemblyVersion"));
        Assert.Equal("1.5.0.15", ProjectProperty(project, "FileVersion"));
