...
public sealed class WindowsDistributionTests : IDisposable
{
    ...
    public void MarketingAssemblyFileAndPackageVersionsStayAligned()
    {
        ...
        Assert.Equal("1.8.2", ProjectProperty(project, "Version"));
        Assert.Equal("1.8.2.21", ProjectProperty(project, "AssemblyVersion"));
        Assert.Equal("1.8.2.21", ProjectProperty(project, "FileVersion"));
