...
2026-09-07 Windows `1.8.2.21` 릴리스 후보는 PNG·스프라이트 결과의 공통 캔버스와 crop 경계, 애니메이션 전체 재생·선택 프레임 미리보기와 기존 atlas frame의 저장 crop 보존을 반영했다. Debug·Release 각각 총 342개 테스트와 경고·오류 없는 전체 빌드를 통과했다. 미서명 x64 설치기와 원격 digest 검증 뒤 `windows-v1.8.2-preview.1`로 게시한다.
