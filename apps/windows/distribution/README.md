...
Windows `1.2.0.13`은 Git 태그 `windows-v1.2.0-preview.1`과 GitHub Pre-release `MonglePet Windows 1.2.0 Preview 1`로 게시했다. 최종 설치기 크기는 63,847,413 bytes이고 SHA-256은 `95C4446A42266E279D55138862EE4E2076BA46661F33E4FAFAA26D4CDF064A8A`이다.

- 릴리스: <https://github.com/saehajoo/MonglePet/releases/tag/windows-v1.2.0-preview.1>
